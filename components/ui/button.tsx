...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-white shadow-glass hover:bg-primary-hover",
        outline: "border border-borderSoft bg-white/60 text-foreground backdrop-blur-glass hover:bg-white/80",
        secondary: "bg-primary-soft text-primary hover:bg-primary-soft/80",
        ghost: "text-mutedText hover:bg-white/50",
        destructive: "bg-coral text-white hover:bg-coral-hover"
      },
      size: {
